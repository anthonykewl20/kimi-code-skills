---
name: zoom-out
description: System context retrieval. Triggers: user says 'explain this module', 'how does this work', 'unfamiliar code', 'architecture overview', OR task requires modifying files in >3 directories.
...
- `improve-codebase-architecture` — typically used after this skill completes
