---
name: to-prd
description: Synthesizes conversation into structured PRD. Triggers: user says 'write a PRD', 'write spec', 'document the plan', 'create specification', OR after alignment grilling is complete.
...
- `to-issues` — typically used after this skill completes
