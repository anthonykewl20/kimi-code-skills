---
name: prototype
description: Throwaway prototype builder. Triggers: user says 'prototype', 'spike', 'experiment', 'try both approaches', 'which design is better'.
...
- `grill-me` — typically used after this skill completes
